...
//     movieUniqueName = 'Tit2015Mxt5';
//  console.log(movieName, movieUniqueName);
...
// let userData = null;//data base request result
...
// val1.push(4);
// // console.log('val1.push(4)');
// // console.log(val1);

//  val1.push(5);
// // // // console.log('val1.push(5)');
// //console.log(val1);

// let tempElement;
// tempElement = val1.pop();
// //console.log('tempElement = val1.pop()');
// // console.log(tempElement);
// // console.log(val1);

// tempElement = val1.shift();
// // console.log('tempElement = val1.shift()');
// // console.log(tempElement);
// // console.log(val1);
...
// val1.splice(1,2);
// //console.log('val1.splice(1,2)');
// console.log(val1);

// val1.splice(0,1,100,200,300,300);
// console.log('val1.splice(0,1,100,200,300,300)');
// console.log(val1);
...
//     console.log(x);
// } else {
//     console.log('something stange just happend');
// }
